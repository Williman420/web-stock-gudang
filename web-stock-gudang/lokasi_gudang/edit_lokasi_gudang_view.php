        ...
        <div class="ml-64 flex flex-col w-full h-full overflow-y-auto px-5 py-6 ">
            ...
            <div class="flex flex-col w-full h-full bg-white rounded-xl p-5">
                <form class="space-y-2">
                    ...
                    <div>
                        <label class="text-sm font-medium block mb-1">Location Code</label>
                        <input type="text" placeholder="LC001" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
