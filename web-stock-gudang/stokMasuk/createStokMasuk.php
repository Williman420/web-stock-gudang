...
// First, insert the stock entry record
mysqli_query($connection, "INSERT INTO stok_masuk (id_produk, id_lokasi, jumlah_masuk, id_supplier, nomor_referensi, keterangan) 
                         VALUES ($id_produk, $id_lokasi, $jumlah_masuk, $id_supplier, '$nomor_referensi', '$keterangan')");
...
if (mysqli_num_rows($result) > 0) {
    ...
    $id_stok = $row['id_stok'];
    $jumlah_baru = $row['jumlah_stok'] + $jumlah_masuk;
    ...
    mysqli_query($connection, "INSERT INTO stok_saat_ini (id_produk, id_lokasi, jumlah_stok) 
                              VALUES ($id_produk, $id_lokasi, $jumlah_masuk)");
    echo "Stock created successfully.";
}

header("location:stok_masuk_view.php");
