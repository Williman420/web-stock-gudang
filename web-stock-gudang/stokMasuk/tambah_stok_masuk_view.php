    ...
    <div class="flex h-full w-full overflow-hidden">
        ...
        <div class="ml-64 flex flex-col w-full h-full overflow-y-auto px-5 py-6 ">
            ...
            <div class="flex flex-col w-full h-full bg-white rounded-xl p-5">
                ...
                $idSupplier =  mysqli_query($connection, "SELECT id_supplier, nama_supplier FROM supplier");
                $idLokasi =  mysqli_query($connection, "SELECT id_lokasi, nama_lokasi FROM lokasi_gudang");
                ?>
                <form class="space-y-2" action="createStokMasuk.php" method="post">
                    <div>
                        <label class="text-sm font-medium block mb-1">Produk Name</label>
                        <select placeholder="Supplier 1" name="id_produk" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <select placeholder="Supplier 1" name="id_supplier" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="">Supplier Name</option>
                            <?php foreach ($idSupplier as $supplier) : ?>
                    ...
                    <div>
                        ...
                        <select placeholder="Supplier 1" name="id_lokasi" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Stock Amount" required name="jumlah_masuk" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
