    ...
    <div class="flex w-full overflow-hidden">
        ...
        <div class="flex ml-64 flex-col w-full h-full overflow-y-auto px-5 py-6 ">
            ...
            <div class="flex flex-col w-full h-full bg-white rounded-xl p-5">
                <form class="space-y-2" action="../lokasi_gudang/createLokasi.php" method="post">
                    <div>
                        <label class="text-sm font-medium block mb-1">ID Location</label>
                        <input type="text" name="kode_lokasi" placeholder="L001" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label class="text-sm font-medium block mb-1">Location</label>
                        <input type="text" name="nama_lokasi" placeholder="Location" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label class="text-sm font-medium block mb-1 ">Capacity</label>
                        <input type="text" name="kapasitas" placeholder="0" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
