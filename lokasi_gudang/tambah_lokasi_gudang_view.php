    ...
    <div class="flex w-full overflow-hidden">
        ...
        <div class="flex ml-64 flex-col w-full h-full overflow-y-auto px-5 py-6 ">
            ...
            <div class="flex flex-col w-full h-full bg-white rounded-xl p-5">
                <form class="space-y-2" action="createLokasi.php" method="post" >
                    <div>
                        <label class="text-sm font-medium block mb-1">Kode Lokasi</label>
                        <input type="text"  placeholder="L001" name="kode_lokasi" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label class="text-sm font-medium block mb-1">Nama Lokasi</label>
                        <input type="text"  placeholder="Location" name="nama_lokasi" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label class="text-sm font-medium block mb-1 ">Kapasitas</label>
                        <input type="text" nameplaceholder="0"  name="kapasitas" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
